					...
					<div className="max-w-6xl mx-auto">
						...
						<motion.div
							...
							<motion.p
								...
								Three interconnected areas that drive my
								curiosity and shape my approach to technology
							</motion.p>
						</motion.div>
						...
						<div className="grid md:grid-cols-3 gap-8">
							{CORE_INTERESTS.map((interest, index) => (
								<motion.div
									...
									{/* Floating Elements */}
									<motion.div
										className={`absolute -top-2 -right-2 w-4 h-4 rounded-full bg-gradient-to-r ${interest.color} opacity-60`}
										animate={{
											scale: [1, 1.2, 1],
											opacity: [0.6, 1, 0.6],
										}}
									...
									<motion.div
										className={`absolute -bottom-2 -left-2 w-3 h-3 rounded-full bg-gradient-to-r ${interest.color} opacity-40`}
										animate={{
											scale: [1, 1.3, 1],
											opacity: [0.4, 0.8, 0.4],
										}}
